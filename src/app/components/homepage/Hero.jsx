...
export default function Hero() {
  return (
        <div className='min-h-[60vh] flex items-center justify-center relative inset-0  overflow-hidden px-5'> 
           ...
           <motion.div initial={{opacity:0, scale:0}} animate={{opacity:1 , scale:1}} transition={{duration: 0.6, type:"spring", bounce: 0.4}}>
            ...
            <div className='space-x-4 flex items-center justify-center'>
              <Link href={'#projects'} className='cursor-pointer'>
                <button className='bg-black rounded-full px-4 py-3 text-white flex items-center gap-2 text-sm'>View My Work<FaLongArrowAltRight /> </button>
              </Link>
